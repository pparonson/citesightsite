    ...
    props: {
        tags: {
            ...
            // validator(value) {
                ...
                // return value.every(tag => Array.isArray(tag) && tag.length === 2 && typeof tag[0] === 'string' && typeof tag[1] === 'string');
            // },
        },
        editable: {
            type: Boolean,
